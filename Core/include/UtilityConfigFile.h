...
namespace BehaveRT {
    ...
    /** \brief Class for quickly loading settings from a text file.
        @remarks
    ...
    */
    ...
    public:
        ...
        UtilityConfigFile();
		UtilityConfigFile(const std::string& filename, const std::string& separators = "\t:=", bool trimWhitespace = true);
        virtual ~UtilityConfigFile();
