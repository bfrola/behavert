...
////////////////////////////////////////////////////////////////////////////////
void BehaveRT::RadixSort(KeyValuePair *pData0, KeyValuePair *pData1, BehaveRT::uint elements, BehaveRT::uint bits)
{
	
    // Round element count to total number of threads for efficiency
    BehaveRT::uint elements_rounded_to_3072;
    ...
    for (BehaveRT::uint shift = 0; shift < bits; shift += RADIX)
    {
